...
public class Affichertype {
  ...
  private void initialize() {
    ...
    Quitter.addActionListener(new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            Affichertype.this.frame = new JFrame("quitter");
            if (JOptionPane.showConfirmDialog(Affichertype.this.frame, "Voulez-vous réelement quitter l'appli Banque?", "IE Bank", 
                0) == 0)
              System.exit(1); 
          }
        });
    ...
    JButton btnAfficher = new JButton("Rechercher");
          ...
          public void actionPerformed(ActionEvent e) {
            ...
            try {
              ...
              while (in.hasNext()) {
                ...
                if (line.contains(Affichertype.this.Type.getText().toUpperCase())) {
            ...
            try {
              ...
              DefaultTableModel model = (DefaultTableModel)Affichertype.this.table.getModel();
            ...
            Affichertype.this.Type.setText("");
          }
        });
    btnAfficher.setBounds(1054, 30, 98, 23);
    this.frame.getContentPane().add(btnAfficher);
    JLabel lblNewLabel = new JLabel("Listes des comptes(Par Type)");
    ...
    JButton recommencer = new JButton("Re initialiser");
